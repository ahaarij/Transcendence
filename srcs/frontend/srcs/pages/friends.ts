...
export async function Friends() {
        ...
        friends.forEach(friend => {
            ...
            item.innerHTML = `
                <div class="flex items-center gap-3">
                    <img src="${getAvatarUrl(friend.avatar)}" referrerpolicy="no-referrer" class="w-10 h-10 rounded-full object-cover border border-neon-blue">
    ...
    function renderRequests(requests: any[]) {
        ...
        requests.forEach(req => {
            ...
            item.innerHTML = `
                <div class="flex items-center gap-3">
                    <img src="${getAvatarUrl(req.from.avatar)}" referrerpolicy="no-referrer" class="w-10 h-10 rounded-full object-cover">
        ...
        try {
            ...
            content.innerHTML = `
                <div class="flex flex-col items-center mb-8">
                    <div class="relative">
                        <img src="${getAvatarUrl(friend.avatar)}" referrerpolicy="no-referrer" class="w-32 h-32 rounded-full object-cover border-4 border-white/10 shadow-lg ring-2 ring-neon-blue">
