...
function createToastContainer() {
    ...
    container.className = 'fixed top-5 right-5 z-[100] flex flex-col gap-2';
    document.body.appendChild(container);
    return container;
}

export function showInputModal(title: string, placeholder: string, onConfirm: (value: string) => void) {
    ...
    const input = modal.querySelector('#modalInput') as HTMLInputElement;
