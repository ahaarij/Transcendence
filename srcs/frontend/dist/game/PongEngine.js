import { GAME_WIDTH, GAME_HEIGHT, PADDLE_HEIGHT, PADDLE_OFFSET, PADDLE_WIDTH, PADDLE_SPEED, BALL_SIZE, BALL_SPEED } from "./types.js";
export class PongEngine {
    state;
    lastPaddle = null; // prevent speed stacking on same paddle
    winningScore = 11; // default winning score
    constructor() {
    ...
    checkPaddleCollision() {
        ...
        // --- PLAYER 1 (LEFT) ---
        if (ball.x <= PADDLE_OFFSET + PADDLE_WIDTH &&
